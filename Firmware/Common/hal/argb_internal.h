...
#define ARGB_CLC_PWM_SPI_PERIPHERAL CLC1
...
#define ARGB_SPI_IF SPI1IF
#define ARGB_SPI_TCNTH SPI1TCNTH
#define ARGB_SPI_TCNTL SPI1TCNTL
#else
...
#define ARGB_SPI_IF SPI2IF
#define ARGB_SPI_TCNTH SPI2TCNTH
#define ARGB_SPI_TCNTL SPI2TCNTL
#endif 
